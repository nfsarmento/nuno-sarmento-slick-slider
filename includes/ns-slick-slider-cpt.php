 ...
 *
 * @package Slider Custom Post Type
 */
...
function nuno_sarmento_nsss_slick_custom_posts() {
	...
	$labels = array(
		...
		'parent_item_colon'   => __( 'Parent Slider:', 'nuno-sarmento-nsss-slick-slider' ),
		'all_items'           => __( 'All Sliders', 'nuno-sarmento-nsss-slick-slider' ),
		'view_item'           => __( 'View Slider', 'nuno-sarmento-nsss-slick-slider' ),
		'add_new_item'        => __( 'Add New Slider', 'nuno-sarmento-nsss-slick-slider' ),
		'add_new'             => __( 'Add New', 'nuno-sarmento-nsss-slick-slider' ),
		'edit_item'           => __( 'Edit Slider', 'nuno-sarmento-nsss-slick-slider' ),
		'update_item'         => __( 'Update Slider', 'nuno-sarmento-nsss-slick-slider' ),
		'search_items'        => __( 'Search Slider', 'nuno-sarmento-nsss-slick-slider' ),
